...
public class JVerificationPlugin extends CordovaPlugin {
    ...
    public boolean execute(final String action, final JSONArray args, final CallbackContext callbackContext) throws JSONException {
        ...
        cordova.getThreadPool().execute(new Runnable() {
            ...
            public void run() {
                try {
                    Method method = cn.jiguang.cordova.verification.JVerificationPlugin.class.getDeclaredMethod(action, JSONArray.class,
                            CallbackContext.class);
                    method.invoke(cn.jiguang.cordova.verification.JVerificationPlugin.this, args, callbackContext);
                } catch (Throwable e) {
                    e.printStackTrace();
...
//    }
     ...
     * @Description:
     */
    private JVerifyUIConfig getFullScreenPortraitConfig(CallbackContext callbackContext){
        ...
        uiConfigBuilder.setNavReturnImgPath("btn_back"); // 依赖图片btn_back.png
        uiConfigBuilder.setCheckedImgPath(null);
        uiConfigBuilder.setNumberColor(0xFF222328);
        uiConfigBuilder.setLogBtnImgPath("selector_btn_normal"); // 依赖selector_btn_normal.xml
        ...
        uiConfigBuilder.setPrivacyText("登录即同意《","","","》并授权学车小王子获取本机号码");
        ...
        layoutParamPhoneLogin.setMargins(0, dp2Pix(mContext,360.0f),0,0);
    ...
    void loginAuth(JSONArray data, final CallbackContext callbackContext) throws JSONException {
        ...
        // 其它方式登录
        JVerificationInterface.setCustomUIWithConfig(getFullScreenPortraitConfig(callbackContext));
